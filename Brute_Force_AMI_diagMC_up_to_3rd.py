...
def acp_rt(M_P,M_O,NUMBER_P,NUMBER_O,int_P,int_O):  # Return the acceptance ratio
  ...
  if M_P>=4 or M_P<=0:  # If the order is out of range
    val=0.0
...
###################################
#Begin
def measurement(x1,x2,x3):  # xi: Markov's chain corresponding to Ni
  var1=0.0  
  var2=0.0
  var3=0.0
  avg_1=0.0
  ...
  #print 'error_1 = ', var1
  var3 = sqrt(var3/(len(x2)-1))
  var3 = var3/sqrt(len(x2))
  #print 'error_2 = ', var2
